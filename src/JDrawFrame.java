...
public class JDrawFrame extends JFrame{
...
//    public static final int ERASER_TOOL =4;
    ...
    protected Tool currentTool = new ScribbleTool(canvas);
    ...
    static public void main(String args[])
    {
        try {
            ...
            (new JDrawFrame()).setVisible(true);
        }
        catch (Throwable t) {
            t.printStackTrace();
    ...
    protected void addToolbarButtons(JToolBar toolBar) {
        ...
        clearb = new JButton(new ImageIcon("src/clear.gif"));
        ...
        scribbleb = new JButton(new ImageIcon("src/scribble.gif"));
        ...
        lineb = new JButton(new ImageIcon("src/line.gif"));
        ...
        rectangleb = new JButton(new ImageIcon("src/rectangle.gif"));
        ...
        ovalb = new JButton(new ImageIcon("src/oval.gif"));
        ...
        eraseb = new JButton(new ImageIcon("src/eraser.gif"));
